...
while True:
    try:
        ...
        # # l1_exercises.print_lidar_calib(frame)
        ...
        configs.conf_thresh = 0.5 #Intersection of Union threshold
        ...
        l2_exercises.pcl_to_bev(cropped_pcl, configs, False)
