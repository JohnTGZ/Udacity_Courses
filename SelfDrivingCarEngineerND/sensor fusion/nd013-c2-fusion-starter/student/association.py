...
class Association:
    ...
    def __init__(self):
        ...
        #indices of all measurements and tracks that did not get associated.
    ...
    def associate(self, track_list, meas_list, KF):
        ...
        self.association_matrix = np.ones((M, N)) * np.inf
        ...
        for i in range(0, M):
            for j in range(0, N):
                mhd_dist = self.MHD(track_list[i], meas_list[j], KF)
                if self.gating(mhd_dist, meas_list[j].sensor):
    ...
    def MHD(self, track, meas, KF):
        ...
        mhd_dist = gamma.transpose() * np.linalg.inv(S) * gamma
