    ...
    def manage_tracks(self, unassigned_tracks, unassigned_meas, meas_list):  
        ...
        for i in unassigned_tracks:
            ...
            if meas_list: # if not empty
                if meas_list[0].sensor.in_fov(track.x): # check if an object x can be seen by this sensor
                    # your code goes here
                    track.state =  'tentative'
                    #Decrease track score for unassigned track
