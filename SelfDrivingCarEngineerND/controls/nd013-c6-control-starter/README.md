...
`/opt/carla-simulator/CarlaUE4.sh -vulkan -RenderOffScreen`

```
cd ~/testbed_cpp/Udacity-Projects/self_driving_car/controls/nd013-c6-control-starter/project/pid_controller && make && cd ~/testbed_cpp/Udacity-Projects/self_driving_car/controls/nd013-c6-control-starter/project && ./run_main_pid.sh
```


source /home/workspace/.student_bashrc && cd /home/workspace/nd013-c6-control-starter/project/pid_controller &&  make && cd /home/workspace/nd013-c6-control-starter/project/ && ./run_main_pid.sh
